...
By the [Gibbs inequality]({{ site.baseurl }}{% post_url 2017-10-27-EM %}), we have that for two continuous density functions $ p\ge 0  $ and $ q>0  $ on an interval $ I\subset \mathbb R  $,
